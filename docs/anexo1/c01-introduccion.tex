...
\begin{quote}
    ...
    \begin{itemize}
        ...
        \item Integrar una interfaz intuitiva y amigable que permita a los usuarios seleccionar y
              personalizar las experiencias de entretenimiento. - Proporcionar métricas y
              estadísticas de rendimiento (movimiento, esfuerzo, etc.) que promuevan el ejercicio
              físico y la mejora personal.
    \end{itemize}
