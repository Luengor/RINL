...
En total se han completado \textbf{568} puntos de historia distribuidos en \textbf{192} tareas
y \textbf{21} sprints. A excepción de los últimos sprints, en los que se dedicó todo el tiempo
disponible al trabajo de fin de grado, se han trabajado una media de \textbf{2} horas diarias.
También se podría estimar que el tiempo trabajado en los tres últimos sprints ha sido de \textbf{8}
horas diarias. Esto supone un total de \textbf{420} horas de trabajo aproximadamente. Por tanto, un
punto de historia ha requerido aproximadamente \textbf{45} minutos de trabajo.
...
se ha ido reduciendo a medida que se ha ido avanzando en el proyecto. Esto se debe a varias razones,
la principal es la falta de experiencia en el desarrollo y planificación de proyectos de software.
También ha influido el hecho de que conforme se fue acercando el final del proyecto, el tamaño de
las tareas se fue incrementando, lo que influenció en los errores cometidos, como se verá en el
siguiente apartado.
