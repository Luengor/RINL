...
no puedo estimar con precisión el esfuerzo necesario para completar tareas que aún no sé
...
\parencites{AgileManifesto}{abrahamsson2017agile}. La planificación ágil resuelve justo
...
el proyecto avanza \parencite{robert2003agile}.

\diagrama{
    nombre = {Planificación ágil},
    fuente = {Planbox, Creative Commons},
...
Scrum es un marco de trabajo ligero y ágil que se utiliza para gestionar proyectos de
...
un conjunto de tareas a completar. Aumentar o disminuir la duración de los sprints afecta de
...
producto, que se actualiza continuamente a medida que se identifican nuevas tareas o se trasladan
...
entregable al cliente \parencite{schwaber2020scrum}.

Para representar gráficamente el proceso del sprint se ha utilizado un panel similar al de Kanban
(ver Figura \ref{anexo3:fig:kanban}), donde cada columna representa un estado del proceso
como puede ser \enquote{Por hacer}, \enquote{En proceso} y \enquote{Hecho}. Este panel permite visualizar
el flujo de trabajo y el progreso del equipo durante el sprint, facilitando la identificación de cuellos
de botella y la gestión del trabajo pendiente.

\diagrama{
    nombre = {Panel de sprint en Jira},
...
Scrum define tres roles principales: el \textit{Product Owner}, el \textit{Scrum Master} y el equipo de desarrollo.
El \textit{Product Owner} es responsable de definir y priorizar los requisitos del producto, asegurando
que el equipo trabaje en las tareas más importantes para el cliente. El \textit{Scrum Master} es el encargado
de facilitar el proceso de Scrum, eliminando obstáculos y asegurando que el equipo siga las guías
establecidas. El equipo de desarrollo es el que realiza el trabajo técnico, desarrollando el software
y cumpliendo los requisitos del \textit{Product Owner} \parencite{schwaber2020scrum}.

En este proyecto, todos los roles han sido asumidos por el autor, ya que es un proyecto individual.
Por tanto, recaía en este la responsabilidad de definir y priorizar los requisitos del producto,
gestionar y facilitar el proceso de Scrum, y realizar el trabajo técnico de desarrollo del software.
...
% puede ser \enquote{Por hacer}, \enquote{En proceso} y \enquote{Hecho}. Además, tiene varias diferencias con Scrum, como
...
% se consigue, por ejemplo, limitando el número de tareas que pueden estar en la columna \enquote{En proceso}
