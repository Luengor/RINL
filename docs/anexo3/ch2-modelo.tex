...
Para la planificación del proyecto se ha utilizado un modelo ágil, específicamente Scrumban, que
combina elementos de Scrum y Kanban. Se ha optado por un enfoque con una gestión ágil en lugar
...
En este proyecto, ya que es un proyecto personal, se asume que el rol de Product Owner, Scrum Master
y equipo de desarrollo son desempeñados por la misma persona, es decir, yo.
...
puede ser ``Por hacer'', ``En proceso'' y ``Hecho''. Esto permite al equipo ver el estado actual de las
tareas e identificar de manera rápdia aquellas tareas que estén bloqueadas, necesiten antención o estén
...
pero también incorpora la visualización del flujo de trabajo de Kanban para mostrar el estado de
las tareas en cada sprint. Además, Scrum añade la planificación de sprints y las reuniones
diarias, lo que permite al equipo revisar el progreso apoyándose en lo aportado por Kanban.
