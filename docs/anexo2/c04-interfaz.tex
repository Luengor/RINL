...
distancia. La réplica del cuerpo del usuario se muestra con esferas brillantes
de color naranja y azul conectadas por líneas blancas, que son fácilmente
distinguibles y reconocibles desde lejos.
...
parpadean y hacen sonidos al aparecer para llamar la atención del usuario.

% Foto de obstáculo por ejemplo

\subsection{Retroalimentación}
Se entiendo por retroalimentación (conocido también como \textit{feedback}) a la
